...
package STM32_SVD.NVIC is
   ...
   type NVIC_Peripheral is record
      ...
      --  Interrupt Set-Enable Register
      ISER1 : aliased STM32_SVD.UInt32;
      --  Interrupt Clear-Enable Register
      ICER0 : aliased STM32_SVD.UInt32;
      --  Interrupt Clear-Enable Register
      ICER1 : aliased STM32_SVD.UInt32;
      --  Interrupt Set-Pending Register
      ISPR0 : aliased STM32_SVD.UInt32;
      --  Interrupt Set-Pending Register
      ISPR1 : aliased STM32_SVD.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR0 : aliased STM32_SVD.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR1 : aliased STM32_SVD.UInt32;
      --  Interrupt Active Bit Register
      IABR0 : aliased STM32_SVD.UInt32;
      --  Interrupt Active Bit Register
      IABR1 : aliased STM32_SVD.UInt32;
      --  Interrupt Priority Register
