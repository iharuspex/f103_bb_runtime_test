...
package STM32_SVD.ADC is
   ...
   subtype CR1_DUALMOD_Field is STM32_SVD.UInt4;
   ...
   subtype CR2_CAL_Field is STM32_SVD.Bit;
   subtype CR2_RSTCAL_Field is STM32_SVD.Bit;
   subtype CR2_DMA_Field is STM32_SVD.Bit;
   subtype CR2_ALIGN_Field is STM32_SVD.Bit;
   subtype CR2_JEXTSEL_Field is STM32_SVD.UInt3;
   subtype CR2_JEXTTRIG_Field is STM32_SVD.Bit;
   subtype CR2_EXTSEL_Field is STM32_SVD.UInt3;
   subtype CR2_EXTTRIG_Field is STM32_SVD.Bit;
   subtype CR2_JSWSTART_Field is STM32_SVD.Bit;
   subtype CR2_SWSTART_Field is STM32_SVD.Bit;
   subtype CR2_TSVREFE_Field is STM32_SVD.Bit;
   ...
   subtype DR_ADC2DATA_Field is STM32_SVD.UInt16;
