...
package STM32_SVD.RCC is
   ...
   subtype CFGR_ADCPRE_Field is STM32_SVD.UInt2;
   ...
   subtype CFGR_OTGFSPRE_Field is STM32_SVD.Bit;
   ...
   subtype APB2RSTR_AFIORST_Field is STM32_SVD.Bit;
   subtype APB2RSTR_IOPARST_Field is STM32_SVD.Bit;
   subtype APB2RSTR_IOPBRST_Field is STM32_SVD.Bit;
   subtype APB2RSTR_IOPCRST_Field is STM32_SVD.Bit;
   subtype APB2RSTR_IOPDRST_Field is STM32_SVD.Bit;
   subtype APB2RSTR_IOPERST_Field is STM32_SVD.Bit;
   subtype APB2RSTR_IOPFRST_Field is STM32_SVD.Bit;
   subtype APB2RSTR_IOPGRST_Field is STM32_SVD.Bit;
   subtype APB2RSTR_ADC1RST_Field is STM32_SVD.Bit;
   subtype APB2RSTR_ADC2RST_Field is STM32_SVD.Bit;
   ...
   subtype APB2RSTR_ADC3RST_Field is STM32_SVD.Bit;
   ...
   subtype APB1RSTR_BKPRST_Field is STM32_SVD.Bit;
   ...
   subtype AHBENR_DMA1EN_Field is STM32_SVD.Bit;
   ...
   subtype AHBENR_FSMCEN_Field is STM32_SVD.Bit;
   subtype AHBENR_SDIOEN_Field is STM32_SVD.Bit;
   ...
   subtype APB2ENR_AFIOEN_Field is STM32_SVD.Bit;
   subtype APB2ENR_IOPAEN_Field is STM32_SVD.Bit;
   subtype APB2ENR_IOPBEN_Field is STM32_SVD.Bit;
   subtype APB2ENR_IOPCEN_Field is STM32_SVD.Bit;
   subtype APB2ENR_IOPDEN_Field is STM32_SVD.Bit;
   subtype APB2ENR_IOPEEN_Field is STM32_SVD.Bit;
   subtype APB2ENR_IOPFEN_Field is STM32_SVD.Bit;
   subtype APB2ENR_IOPGEN_Field is STM32_SVD.Bit;
   ...
   subtype APB1ENR_BKPEN_Field is STM32_SVD.Bit;
